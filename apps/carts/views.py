...
def cart_page(request):
    ...
    context['total_price'] = context["cart_total_price"] * shipping_percent / 100 + context["cart_total_price"] - request.session.get('coupon_data', {}).get('discount_percent', 0) * context["cart_total_price"]/100
